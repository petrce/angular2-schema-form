...
export { ArrayWidget, CheckboxWidget, FileWidget, IntegerWidget, ObjectWidget, RadioWidget, RangeWidget, SelectWidget, StringWidget, TextAreaWidget, ButtonWidget, DefaultWidgetRegistry } from './defaultwidgets';
