...
var FormProperty = /** @class */ (function () {
    ...
    Object.defineProperty(FormProperty.prototype, "propertyId", {
        get: function () {
    ...
    Object.defineProperty(FormProperty.prototype, "metadata", {
        get: function () {
            if (this._metadata != null) {
                return this._metadata;
            }
            if (!this._parent) {
                var fieldsets = this.root.schema.fieldsets;
                if (!fieldsets) {
                    return undefined;
                }
                var metadata = fieldsets.map(function (x) { return x.fieldProperties; }).filter(function (x) { return x != null; });
                if (metadata.length) {
                    metadata = metadata.reduce(function (acc, arr) { return Object.assign(acc, arr); });
                }
                this._metadata = metadata;
            }
            else {
                var rootMeta = this.root.metadata;
